...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Return start state and tuple with corner info
    ...
    def isGoalState(self, state: Any):
        ...
        """
        "*** YOUR CODE HERE ***"
        # The goal is to visit all 4 corners
    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[int(x + dx)][int(y + dy)]: # check if nextState is not a wall
                ...
                successors.append(((nextState, next_visited), action, 1)) # step cost = 1
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    "*** YOUR CODE HERE ***"
    if foodGrid.count() == 0:
        return 0 # return 0 if there is no more food left
